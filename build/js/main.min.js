...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var phoneInput = document.querySelector('.form__phone input'); // Проверка JS
  ...
  */
  ...
  videoContainer.addEventListener('click', removeVideoCover); // Цены на абонементы
  ...
  Object(_js_vendor_mask_js__WEBPACK_IMPORTED_MODULE_1__["maskPhone"])('.form__phone input');
});
