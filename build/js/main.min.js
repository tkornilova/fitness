...
/* harmony import */ var _js_vendor_swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../js/vendor/swiper */ "./js/vendor/swiper.js");
/* harmony import */ var _js_vendor_mask_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../js/vendor/mask.js */ "./js/vendor/mask.js");


window.addEventListener('DOMContentLoaded', function () {
  var bodyWrapper = document.querySelector('.wrapper');
  var videoContainer = document.querySelector('.gym__video');
  var video = document.querySelector('iframe');
  var videoButton = document.querySelector('.gym__video button');
  var durationList = document.querySelectorAll('.prices__duration > p');
  var priceLists = document.querySelectorAll('.prices__options ul');
  var reviewsList = document.querySelectorAll('.reviews__item');
  var form = document.querySelector('.form__wrapper form');
  var phoneInput = document.querySelector('.form__phone input');
  var nameInput = document.querySelector('.form__name input');
  var formButton = document.querySelector('.form__wrapper button'); // Проверка JS
  ...
  var removeVideoCover = function removeVideoCover() {
  ...
  */
  ...
  videoButton.addEventListener('click', removeVideoCover); // Цены на абонементы

  var changePriceCard = function changePriceCard(duration) {
    duration.addEventListener('click', function () {
      var index = Array.from(durationList).indexOf(duration);
      durationList.forEach(function (item) {
  ...
  for (var i = 0; i < durationList.length; i++) {
    durationList.forEach(function (duration) {
      ...
      duration.addEventListener('keydown', function (evt) {
  ...
  Object(_js_vendor_mask_js__WEBPACK_IMPORTED_MODULE_1__["maskPhone"])('.form__phone input'); // Submit form
